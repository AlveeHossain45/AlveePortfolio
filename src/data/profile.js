...
export default {
  ...
  // পরিবর্তন: 'about' টেক্সটটি সংক্ষিপ্ত এবং আরও আকর্ষণীয় করা হয়েছে
  about: "A passionate developer building beautiful, responsive web apps while exploring cybersecurity and advanced web technologies.",
  photo: "/alvee.jpg",
  photo1: "/alveeh.jpg",
  features: [
    "Responsive (mobile + desktop)",
    "Day & Night premium themes",
